...
export const Shef: FunctionComponent = ({}) => {
    ...
    const Cooking = () => {
        ...
        for (let i = 1; i < count; i++) {
            step_texts.push(
                (document.getElementById(`step_text_${i}`) as HTMLInputElement)
                    ?.value
            )
            step_files.push(
                (document.getElementById(`step_file_${i}`) as HTMLInputElement)
                    .value
            )
        }
                ...
                <form action="" id="recipe_form" className="recipe_form">
                    <div id="form_div" className="form-group">
                        ...
                        <input
                            type="text"
                            id="name"
                            className="input_form form-control"
                        />
                        <br />
                        ...
                        <br />
                        <input
                            className="form-control form-control-sm file_form"
                            id="photo"
                            type="file"
                        />
                        <br />
