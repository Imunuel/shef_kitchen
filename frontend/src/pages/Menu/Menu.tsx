...
export const Menu: FunctionComponent = ({}) => {
    const { search_recipes } = useAppSelector(
        (state) => state.SearchRecipesReducer
    )
        ...
        <>
            ...
            <div className="random_recipes">
                <div className="count_parameters">
                    <div className="count_parameter">
                        random recipe
                        <input
                            type="radio"
                            name="count_parameter"
                            className="radio"
                            value={'random'}
                ...
                <button
                    className="btn btn-secondary find"
                    onClick={SearchParametersFunction}
                >
                    find
                </button>
                <div className="position_parameters">
                    <div className="position_parameter">
                        <input
                            className="inp"
                            type="checkbox"
                            value={'breakfast'}
