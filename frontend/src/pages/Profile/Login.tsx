...
<form className="login_form">
  ...
  <button type="button" className="btn btn-secondary" onClick={LogIn}>Sign in</button>
</div>
  <div className="text-center">
    <p>Not a member? <NavLink to={"/registration"} className="colored_link">Register</NavLink></p>
  </div>
  </form>
</>
    )
